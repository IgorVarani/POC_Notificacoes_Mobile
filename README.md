...
Aplicação mobile desenvolvida em React Native criada para demonstrar a integração, gerenciamento e recebimento de notificações push no ecossistema mobile.
...
Notificações: Expo Notifications (ou Firebase Cloud Messaging - FCM)